...
def main():
    ...
    run_pipeline(args.protein_file, args.ligand_file, args.outdir, run_crest_bool=not args.no_crest, base_dir=directory,temp=args.temp, lvl_of_theory=args.lvl_of_theory, extra_crest_args=args.extra_crest_args)
    print(f"AutoPocket2CREST pipeline completed. Results are in the directory: {os.path.join(directory, args.outdir)}")
